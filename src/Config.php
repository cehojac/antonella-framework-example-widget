...
class Config
{
    ...
    * @example ['post_data'=>'VWXYZ::function']
    */
    public $post=[];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'VWXYZ::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','VWXYZ::function',10,2]
    * @example ['body_class',['VWXYZ','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','VWXYZ\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','VWXYZ\ExampleController::example_shortcode']
    ];
    /**
    * Dashboard
